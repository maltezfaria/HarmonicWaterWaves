...
function makie_theme(; width = 469.75499 / 2, height = width * 0.68)
    axis_theme = (
        xlabelsize = 10,
        ylabelsize = 10,
        spinewidth = 1.1,
    ...
    line_theme = (linewidth = 2.0,)

    scatter_theme = (markersize = 7,)
    ...
    heatmap_theme = (colormap = :inferno, interpolate = true)

    colorbar_theme =
        (ticklabelsize = 8, labelsize = 8, labelrotation = 0, colormap = :inferno)
