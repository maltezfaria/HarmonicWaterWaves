...
vlines!(ax2,[-pml_start,pml_start];ymin=0,ymax=1, linestyle=:dash, color=(:black,0.5))
lines!(ax2,tank.mesh)
...
vlines!(ax3,[-pml_start,pml_start];ymin=0,ymax=1, linestyle=:dash, color=(:black,0.5))
lines!(ax3,tank.mesh)
...
if make_animation
    ...
    record(fig, "paper/animations/double_piercing_animation.gif", timestamps;
